...
class StdoutTest < ServiceTest
  def test_it_prints_the_digest_so_a_run_can_be_checked_without_telegram
    Messengers::Stdout.new.send_message("<b>Yelmo Cines Ocimax Gijón</b>\n• Sat → 19:30")
  ...
  def test_it_takes_the_telegram_markup_back_off
    ...
    Messengers::Stdout.new.send_message(
  ...
  def test_it_does_not_shorten_the_digest
    ...
    Messengers::Stdout.new.send_message(long_week)
  ...
  def test_it_can_be_built_the_same_way_as_the_telegram_messenger
    ...
    messenger = Messengers::Stdout.new(token: "unused", chat_id: "unused")
